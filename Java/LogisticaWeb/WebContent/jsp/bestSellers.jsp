<%@page import="com.logistica.dtos.ItemBestSellerDTO"%>
<%@page import="com.logistica.dtos.BestSellerDTO"%>
...
<title>Ranking BestSellers</title>
</head>
<body>
<%
	BestSellerDTO bestSeller = (BestSellerDTO) request.getAttribute("bestSeller");	
%>
	...
	<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
		...
		<div class="mdl-layout__header-row">
			<!-- Title -->
			<span class="mdl-layout-title">Ranking BestSellers</span>
		...
		<!-- Your content goes here -->
			<table class="mdl-data-table mdl-js-data-table mdl-shadow--2dp"
				...
				<thead>
					<tr>
						<th class="mdl-data-table__cell--non-numeric">Posición</th>
						<th class="mdl-data-table__cell--non-numeric">Código Producto</th>
						<th class="mdl-data-table__cell--non-numeric">Cantidad Vendida</th>
						<th class="mdl-data-table__cell--non-numeric">Nombre Depósito</th>
					</tr>
				</thead>
				<tbody>
				<%for(ItemBestSellerDTO itemBest: bestSeller.getItems()){%>
						<tr>
							<td class="mdl-data-table__cell--non-numeric"><%=itemBest.getPosicion()%></td>
							<td class="mdl-data-table__cell--non-numeric"><%=itemBest.getCodigo()%></td>
							<td class="mdl-data-table__cell--non-numeric"><%=itemBest.getVentasAcumuladas()%></td>
							<td class="mdl-data-table__cell--non-numeric"><%=itemBest.getNombreDeposito()%></td>
						</tr>
						<%}%>
				</tbody>
			</table>
	...
	<form action="EnviarBestSellers" method="get">
		<button id="tt3" style="float: right" type="submit"
			class="mdl-button mdl-js-button mdl-button--fab mdl-button--colored">
			<i class="material-icons">add</i>
		</button>
	</form>
	<div class="mdl-tooltip" data-mdl-for="tt3">Enviar a portales</div>
	</footer>
	</div>
</body>
</html>