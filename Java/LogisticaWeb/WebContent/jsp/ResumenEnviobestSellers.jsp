<%@page import="com.logistica.dtos.RecepcionBestSellerDTO"%>
...
<title>Recepción BestSellers</title>
</head>
<body>
<%
	List<RecepcionBestSellerDTO> resultadoBestSeller = (List<RecepcionBestSellerDTO>) request.getAttribute("resultadoBestSeller");	
%>
	...
	<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
		...
		<div class="mdl-layout__header-row">
			<!-- Title -->
			<span class="mdl-layout-title">Recepción BestSellers</span>
		...
		<!-- Your content goes here -->
			<table class="mdl-data-table mdl-js-data-table mdl-shadow--2dp"
				...
				<thead>
					<tr>
						<th class="mdl-data-table__cell--non-numeric">Nombre Portal</th>
						<th class="mdl-data-table__cell--non-numeric">Resultado</th>
					</tr>
				</thead>
				<tbody>
				<%for(RecepcionBestSellerDTO recepcion: resultadoBestSeller){%>
						<tr>
							<td class="mdl-data-table__cell--non-numeric"><%=recepcion.getNombrePortal()%></td>
							<td class="mdl-data-table__cell--non-numeric"><%if(recepcion.getMensaje().equalsIgnoreCase("Actualizacion Exitosa")){%><img src="images/tildeVerde.png" /></td>
