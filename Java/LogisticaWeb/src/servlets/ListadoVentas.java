 ...
 */
@WebServlet("/ListadoVentas")
public class ListadoVentas extends HttpServlet {
...
//			bd = BusinessDelegate.getInstance();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			ventas = BusinessDelegate.getInstance().obtenerUltimasVentas();
		} catch (Exception e) {
			e.printStackTrace();
		}
		...
		request.getRequestDispatcher("jsp/ultimasVentas.jsp").forward(request, response);
